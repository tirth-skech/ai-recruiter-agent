...
# --- 2. DUCKDUCKGO LIVE JOB SEARCH ENGINE (QUOTA-FREE) ---
def fetch_live_ddg_jobs(search_term="AI Engineer"):
    ...
    # 2. Extract and format structured JSON using standard Gemini Flash (0 Search Grounding quota used)
...
with active_tabs[1]:
    ...
    if fetch_clicked:
        with st.spinner(
            f"Fetching live open '{search_keyword}' roles via DuckDuckGo..."
        ):
